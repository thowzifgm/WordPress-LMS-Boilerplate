...
/*
Default sidebar latest comments exclude bloggers
See the WP_Comment_Query::query section in wp-includes/comment.php
Improve query conditions based on incoming parameters
*/
...
/*
Default sidebar latest comments exclude bloggers
See the WP_Widget_Recent_Comments section in wp-includes/default-widgets.php for details
Increase the parameter not_in__user
*/
